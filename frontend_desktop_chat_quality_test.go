...
func TestDesktopChatHeaderAndMessageHierarchyWiring(t *testing.T) {
	...
	for _, want := range []string{
		...
		// AJ 2026-09-02: no dot/STRIDE badge — both pinned channels read "pinned · whole office"
