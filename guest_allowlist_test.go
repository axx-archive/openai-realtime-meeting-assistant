...
func TestGuestRouteWalkAllowlistFailsClosed(t *testing.T) {
	...
	probes := map[string]guestRouteProbe{
		...
		"/assistant/home":                  {handler: assistantHomeHandler, memberGated: true},
		"/assistant/project-context":       {handler: assistantProjectContextHandler, memberGated: true},
		...
		"/assistant/attachments/from-file": {handler: assistantAttachmentFromFileHandler, memberGated: true},
		...
		"/assistant/realtime/should-route":               {handler: assistantRealtimeShouldRouteHandler, memberGated: true},
		...
		"/artifacts/workstream":                          {handler: artifactWorkstreamCorrectionHandler, memberGated: true},
		...
		"/artifacts/preview":                             {handler: artifactPreviewHandler, memberGated: true},
