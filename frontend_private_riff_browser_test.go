...
(async () => {
  ...
  assert.match(await page.locator('#chatContextRail').innerText(),/Scout · private to you|Current pass/);
  ...
  assert.match(await page.locator('#chatContextRail').innerText(),/Talk in Realtime/);
