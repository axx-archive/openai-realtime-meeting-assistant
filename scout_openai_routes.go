...
func scoutRouterInstructions() string {
	...
	return strings.Join([]string{
		...
		"",
		"Intent map:",
		"- presentation/deck/outline asks ('make a 5-slide outline', 'create a deck', 'presentation for this pitch', 'outline the pitch') -> tool_run deck_outline. The deck_outline tool produces a real in-thread deck with slides the user can see.",
		"- full packaging studio run with all artifacts ('run the full deck outline process with review', 'complete package with deck') -> tool_run packaging_studio.",
