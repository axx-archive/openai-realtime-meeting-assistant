...
func meetingBoardInstructions() string {
	return strings.Join([]string{
		...
		"Prefer updating an existing card when the work is already represented. Create a card only for a clear follow-up, commitment, risk, blocker, or work item that is not on the board.",
