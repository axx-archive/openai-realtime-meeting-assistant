...
| **Scout voice** | Native private Realtime 2.1 through `/assistant/realtime-offer`; the production Build 75 profile enables it, while tools, Brain context, thread receipts, usage, and ACLs stay server-authoritative |
...
Build 75 enables native private Realtime in the production EAS profile. Home
