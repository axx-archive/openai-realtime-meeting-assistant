...
var authorizationHTTPSurfaces = []AuthorizationSurface{
	...
	authSurface("http.assistant.chat_thread_members", AuthorizationHTTP, "/assistant/chat-threads/{threadId}/members", []string{"chat_thread", "membership"}, []ACLAction{ACLReadContent, ACLWrite}, []string{"user"}, true, true, AuthorizationLegacyGuarded),
	authSurface("http.assistant.chat_search", AuthorizationHTTP, "/assistant/chat-search", []string{"chat_thread"}, []ACLAction{ACLReadContent}, []string{"user"}, true, true, AuthorizationLegacyGuarded),
	...
	authSurface("http.assistant.deal_room_request", AuthorizationHTTP, "/assistant/deal-room/request", []string{"deal_room", "package", "artifact"}, []ACLAction{ACLReadContent, ACLShare, ACLExport}, []string{"user"}, true, true, AuthorizationCanonicalEnforced),
	authSurface("http.assistant.deal_room_resolve", AuthorizationHTTP, "/assistant/deal-room/resolve", []string{"deal_room", "artifact"}, []ACLAction{ACLReadContent, ACLShare, ACLApprove, ACLExport}, []string{"user"}, true, true, AuthorizationCanonicalEnforced),
	...
	authSurface("http.studio_projects_v1", AuthorizationHTTP, "/api/studio-projects/v1", []string{"artifact", "goal", "revision", "chat_thread", "project"}, []ACLAction{ACLReadContent, ACLWrite, ACLExport}, []string{"user"}, true, true, AuthorizationCanonicalEnforced),
	authSurface("http.artifacts.deck", AuthorizationHTTP, "/artifacts/deck", []string{"artifact", "revision", "blob"}, []ACLAction{ACLReadContent, ACLWrite}, []string{"user"}, true, true, AuthorizationCanonicalEnforced),
	authSurface("http.artifacts.deck_copies", AuthorizationHTTP, "/artifacts/deck/copies", []string{"artifact", "revision", "blob", "file", "folder"}, []ACLAction{ACLReadContent, ACLWrite, ACLCreateChild}, []string{"user"}, true, true, AuthorizationCanonicalEnforced),
	authSurface("http.artifacts.deck_new", AuthorizationHTTP, "/artifacts/deck/new", []string{"artifact", "blob"}, []ACLAction{ACLCreateChild, ACLWrite}, []string{"user"}, true, false, AuthorizationCanonicalNeeded),
	authSurface("http.artifacts.document", AuthorizationHTTP, "/artifacts/document", []string{"artifact", "revision"}, []ACLAction{ACLReadContent, ACLWrite}, []string{"user"}, true, false, AuthorizationCanonicalNeeded),
	authSurface("http.artifacts.final_export_capability", AuthorizationHTTP, "/artifacts/final-export-capability", []string{"artifact", "revision", "workflow"}, []ACLAction{ACLReadContent, ACLExport}, []string{"user"}, true, true, AuthorizationCanonicalEnforced),
