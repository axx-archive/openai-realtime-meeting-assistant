...
- The executable implementation boundary **A** is
  `1503f1beb374e7d4b32c2a1cf2a1244d6b038fee`. This plan is intentionally
...
- Two subsequent protected attempts passed progressively deeper gates and were
  ...
  derives its balanced event/outbox/version delta from the unique sealed
  missing/state candidates, while the terminal gate still requires only the
  seven classified board tombstones.
