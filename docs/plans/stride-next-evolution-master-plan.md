...
> implementation commit `ea56fc21...`; submission `23e7d9a3...` is tracked
> separately, and Apple processing/intended TestFlight-group availability
> remain open. Resume with Project-linked attachment/reply source coverage
...
- **Next:** extend Project-linked source coverage through attachments and
  replies. Then build the authorized recurring compaction and deterministic
